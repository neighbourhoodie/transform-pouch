...
const COUCH_URL = process.env.COUCH_URL || 'http://jacoba:poloch@localhost:5984'
  ...
  describe(dbType + ': advanced tests', function () {
    ...
    if (typeof process !== 'undefined' && !process.browser) {
      ...
      encrypt = function (text) {
        // TODO this needs to be replaced with createDecipheriv()
        // see https://nodejs.org/api/crypto.html#crypto_crypto_createcipheriv_algorithm_key_iv_options
        const cipher = crypto.createCipher('aes-256-cbc', 'password') // eslint-disable-line
      ...
      decrypt = function (text) {
        // TODO this needs to be replaced with createDecipheriv()
        // see https://nodejs.org/api/crypto.html#crypto_crypto_createcipheriv_algorithm_key_iv_options
        const decipher = crypto.createDecipher('aes-256-cbc', 'password') // eslint-disable-line
